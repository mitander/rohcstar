...
//! when to move between different operational modes (NoContext, StaticContext, FullContext,
//! SecondOrder) based on packet reception success/failure patterns. These transitions follow RFC
//! 3095 requirements for robust decompression in unreliable network conditions.
