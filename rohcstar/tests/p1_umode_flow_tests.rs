...
fn p1_umode_ir_to_fo_sequence_cid0() {
    ...
    let rohc_packet_p2 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_headers_p2)
    ...
    let rohc_packet_p3 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_headers_p3)
        .unwrap();
    assert_eq!(
        rohc_packet_p3.len(),
        4,
    ...
    let rohc_packet_p4 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_headers_p4)
        .unwrap();
    assert_eq!(
        rohc_packet_p4.len(),
        3,
    ...
    let rohc_packet_p5 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_headers_p5)
        .unwrap();
    assert_eq!(
        rohc_packet_p5.len(),
        3,
    ...
    let rohc_packet_p6 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_headers_p6)
        .unwrap();
    assert_eq!(
        rohc_packet_p6.len(),
        1,
    ...
    let rohc_packet_p7 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_headers_p7)
        .unwrap();
    assert_eq!(
...
fn p1_umode_sn_jump_triggers_uo1() {
    ...
    let rohc_packet3 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic3)
        .unwrap();
    ...
    let rohc_packet4 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic4)
        .unwrap();
...
fn p1_umode_uo0_sn_decoding_with_simulated_packet_loss() {
    ...
    let rohc_packet_sn103 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_h103)
        .unwrap();
    ...
    let rohc_packet_sn104 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_h104)
        .unwrap();
...
fn p1_umode_ir_to_fo_sequence_cid0_fixed() {
    ...
    let generic_headers2 = GenericUncompressedHeaders::RtpUdpIpv4(original_headers2.clone());
    let rohc_packet2 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_headers2)
        .unwrap();
    assert_eq!(rohc_packet2.len(), 1, "Packet 2 should be UO-0");
    ...
    let generic_headers3 = GenericUncompressedHeaders::RtpUdpIpv4(original_headers3.clone());
    let rohc_packet3 = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_headers3)
        .unwrap();
    assert_eq!(rohc_packet3.len(), 4, "Packet 3 should be UO-1-TS");
    assert_eq!(rohc_packet3[0], P1_UO_1_TS_DISCRIMINATOR);
...
fn p1_umode_ir_to_fo_sequence_cid0_context_consistent() {
    ...
    let uo0_packet = engine
        .compress(cid.into(), Some(RohcProfile::RtpUdpIp), &generic_uo0)
        .unwrap();
